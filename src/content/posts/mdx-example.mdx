...
published: 2026-07-15T11:27:00+10:00
description: 这是一个 MDX 格式的示例文章，展示了如何在 Markdown 中使用 JSX。
descriptionEn: An MDX sample that shows how JSX can be used inside Markdown.
...
:::tip
我们支持 `MDX` 和 `Markdown` 两种类型的文章，编辑人可以在文章中混合使用两种格式，如果没有特别复杂内容和需求，推荐使用 Markdown 格式就够了。
:::
